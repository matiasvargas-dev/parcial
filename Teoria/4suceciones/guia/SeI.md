...
**Suma de n términos:**
$$
S_n = n/2 × (a_1 + a_n)  o  S_n = n/2 × (2a_1 + (n-1)d)
$$

**Ejemplo:** Suma de los primeros 5 términos: $$S_5 = 5/2 × (2 + 14) = 5/2 × 16 = 40$$
...
**Suma de n términos:**
$$
S_n = a_1 × (r^n - 1) / (r - 1)    [si r ≠ 1]
$$

**Ejemplo:** Suma de los primeros 5 términos: `S_5 = 3 × (2^5 - 1) / (2 - 1) = 3 × 31 = 93`
...
- ¿Cuál es `a_10`?
- **Respuesta esperada:** `d = 6`, `a_10 = 5 + 9×6 = 59`
...
- Cálculo: `1.5^15 ≈ 437` vs `100×15 = 1500` (todavía lineal), pero `1.5^50 ≈ 88,000` vs `100×50 = 5000`
...
$$
b_1 = 5
b_n = 2 × b_{n-1}  para n ≥ 2
$$

**Desenrollar:**
$$
b_2 = 2 × b_1 = 2 × 5
b_3 = 2 × b_2 = 2 × (2 × 5) = 2^2 × 5
b_4 = 2 × b_3 = 2 × (2^2 × 5) = 2^3 × 5
b_n = 2^(n-1) × 5
$$

**Fórmula cerrada:** `b_n = 5 × 2^(n-1)`
...
**Proposición:** Demostrar que `1 + 2 + 3 + ... + n = n(n+1)/2` para todo n ≥ 1
...
$$
Asume que P(k) es verdadera:
1 + 2 + 3 + ... + k = k(k+1)/2
$$

#### **PASO 3: TESIS - Demuestra P(k+1)**
$$
Debes demostrar: 1 + 2 + 3 + ... + k + (k+1) = (k+1)(k+2)/2

Desarrollo:
1 + 2 + 3 + ... + k + (k+1)
= [k(k+1)/2] + (k+1)              [Usando hipótesis inductiva]
= (k+1)[k/2 + 1]                  [Factorizamos (k+1)]
= (k+1)[(k + 2)/2]                [Sumamos fracciones]
= (k+1)(k+2)/2                    ✓ (Es exactamente P(k+1))
$$
